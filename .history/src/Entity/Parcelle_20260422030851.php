...
class Parcelle
{
    ...
    // 🔴 تصلحت هوني: ولّات Users::class في بلاصة User::class
    #[ORM\ManyToOne(targetEntity: Users::class)]
    #[ORM\JoinColumn(name: 'utilisateur_id', referencedColumnName: 'id', nullable: true)]
    private ?Users $user = null; // 🔴 النوع ولّى Users

    public function getUsers(): ?Users // 🔴 النوع ولّى Users
    {
        return $this->user;
    }

    public function setUser(?Users $user): self // 🔴 النوع ولّى Users
    {
        $this->user = $user;
        return $this;
    }
