    ...
    public function index(
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($action === 'register') {
                ...
                if (!$pending) {
                    $errors['otp'] = "Session expirée. Renvoyez le code.";
                } elseif (!$faceDescriptor) {
                    $errors['face'] = "Veuillez scanner votre visage.";
                } else {
        ...
        return $this->render('register/Register.html.twig', ['errors' => $errors, 'data' => $data]);
    }
}