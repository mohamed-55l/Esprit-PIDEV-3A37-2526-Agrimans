        ...
        if ($request->isMethod('POST')) {
            ...
            if ($action === 'register') {
                ...
                if (!$pending) {
                    ...
                    $errors['face'] = "Veuillez scanner votre visage avant de valider.";
                } else {
                    ...
                    if (!$otp || $otp->getExpiry() < new \DateTime()) {
                        ...
                        // ✅ تخزين البصمة كـ Array
                        $descriptorArray = json_decode($faceDescriptorRaw, true);
                        $user->setFaceDescriptor($descriptorArray);
                        ...
                        $session->remove('pending_user');
                        $this->addFlash('success', 'Bienvenue chez Agrimans! Compte créé ✅');
