...
class LoginController extends AbstractController
{
    ...
    public function loginFace(Request $request, EntityManagerInterface $em, SessionInterface $session): Response
    {
        ...
        // 💡 Pro Setting: 0.6 is the sweet spot for SSD Mobilenet V1
        $threshold = 0.6; 
        $minDistance = 1.0;
        ...
        return $this->json(['success' => false, 'message' => 'Identité non reconnue.']);
    }
    ...
    private function calculateDistance(array $d1, array $d2): float
    {
        $sum = 0;
